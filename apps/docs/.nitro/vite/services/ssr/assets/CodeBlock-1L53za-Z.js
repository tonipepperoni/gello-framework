...
function CodeBlock({ code, lang = "typescript" }) {
  ...
  if (!html2) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-zinc-900 rounded-lg p-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-sm text-zinc-300", children: code.trim() }) });
  }
