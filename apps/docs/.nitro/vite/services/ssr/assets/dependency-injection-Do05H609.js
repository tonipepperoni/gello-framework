...
function DependencyInjectionPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "prose", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-zinc-400 mb-8", children: "Context.Tag + Layer — NestJS-style modularity with functional composition" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "The Pattern" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Gello's dependency injection takes inspiration from NestJS's service-oriented architecture, but implements it using Effect's functional primitives. Instead of decorators and a runtime container, you get ",
      ...
      " to provide implementations — all type-safe and composable."
    ] }),
