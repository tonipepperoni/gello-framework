...
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-64 shrink-0 border-r border-gruvbox-bg-2 overflow-y-auto h-[calc(100vh-4rem)] sticky top-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "p-4 space-y-6", children: navigation.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-gruvbox-gray uppercase tracking-wider mb-2", children: section.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        ...
        className: clsx(
          ...
          currentPath === item.href ? "bg-gruvbox-orange/10 text-gruvbox-orange font-medium" : "text-gruvbox-fg-4 hover:text-gruvbox-fg hover:bg-gruvbox-bg-1"
        ),
        children: item.title
      }
    ) }, item.href)) })
