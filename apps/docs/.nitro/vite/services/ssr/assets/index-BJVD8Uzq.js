...
function DocsIntroduction() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "prose", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-zinc-400 mb-8", children: "Gello — FP-core backend framework built on Effect" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Gello is a non-modular, purely functional approach to backend development in TypeScript. Built on ",
